...
def main():
    ...
    if uploaded_file is not None:
        ...
        column = st.sidebar.selectbox("Select column for bootstrapping", data.columns)
        data = data[column].dropna().values  # Drop missing values
    else:
        data_size = st.sidebar.slider(
            "Data Size", min_value=10, max_value=1000, value=100
        )
